    ...
    public class ReportGenerator
    {
        ...
        public Stream GeneraReport()
        {
            ...
            for (int i = 0; i < dt.Columns.Count; i++)
            {
                ...
                float HeaderMaxLength = GetDynamicSize(dc.ColumnName).Width ;

                autoWidth = autoWidth + HeaderMaxLength;
            }
                    #endregion
