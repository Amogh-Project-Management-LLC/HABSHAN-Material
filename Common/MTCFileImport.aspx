<%@ Page Title="" Language="C#" MasterPageFile="~/PopupMasterPage.master" AutoEventWireup="true" CodeFile="MTCFileImport.aspx.cs" Inherits="MTCCommon_FileImport" %>
      ...
      <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div>
                <table>
                    <tr>
                        <td style="background-color: whitesmoke; width: 150px; padding-left: 5px;">MTC File Upload</td>
                         <td>
