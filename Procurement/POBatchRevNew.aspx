<%@ Page Title="" Language="C#" MasterPageFile="~/PopupMasterPage.master" AutoEventWireup="true" CodeFile="POBatchRevNew.aspx.cs" Inherits="Procurement_POBatchCreateRev" %>
        ...
        <table>
            <tr >
                ...
                <td style="display:none;">
                    <telerik:RadTextBox runat="server" ID="txtBatchNo"  ></telerik:RadTextBox>
                </td>
                <td class="Heading">Rev No</td>
                <td>
                    <telerik:RadTextBox ID="txtRevNo" runat="server" EmptyMessage="Revision No.." Width="150px"></telerik:RadTextBox>
                </td>
                  <td class="Heading">Create Date</td>
                <td>
                    <telerik:RadDatePicker ID="txtCreateDate" runat="server" DateInput-DateFormat="dd-MMM-yyyy"  Width="150px">
