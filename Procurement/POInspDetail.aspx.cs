...
public partial class Procurement_POInspDetail : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            Master.HeadingMessage += WebTools.GetExpr("RFI_NO", "PIP_PO_INSP_REQUEST", " WHERE RFI_ID='" + Request.QueryString["REQ_ID"].ToString() + "'");
    ...
    {
        Response.Redirect("~/Procurement/POInsp.aspx");
    }
