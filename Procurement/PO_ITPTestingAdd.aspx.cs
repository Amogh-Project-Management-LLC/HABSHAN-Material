...
public partial class Procurement_PO_ITPTestingAdd : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            Master.HeadingMessage("Testing Detail as per ITP - " + po);
        }
    }
    ...
    {
        Procurement_ATableAdapters.VIEW_PO_ITEM_TESTING_ITPTableAdapter insp = new Procurement_ATableAdapters.VIEW_PO_ITEM_TESTING_ITPTableAdapter();
        try
        {
